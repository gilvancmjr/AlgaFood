...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleBindException(BindException ex, HttpHeaders headers, HttpStatus status,
		...
		return handleValidationInterno(ex, headers, status, request, ex.getBindingResult());
	}
	...
	private ResponseEntity<Object> handleValidationInterno(Exception ex, HttpHeaders headers, HttpStatus status,
