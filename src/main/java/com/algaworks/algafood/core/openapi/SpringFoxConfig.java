...
public class SpringFoxConfig {
	...
	public Docket apiDocket() {
		...
		return new Docket(DocumentationType.OAS_30).select()
				...
				.build().useDefaultResponseMessages(false).globalResponses(HttpMethod.GET, globalGetResponseMessages())
...
//			    )
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("AlgaFood").description("API aberta para clientes e restaurantes")
				.version("1").contact(new Contact("Monteiro", "https://www.monteiro.com", "juniormonteiroti@gmail.com"))
				.build();
	}
